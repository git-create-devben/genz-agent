...
import { Sparkles, ArrowRight, FileText, ImageIcon, Type, Film, MessageSquare, } from "lucide-react"
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between ">
          ...
          {!user ? (
            <Button variant="outline" className="hidden md:inline-flex bg-white text-blue-900 hover:bg-gray-100 cursor-pointer">
              <Link href="/sign-up" className="text-blue-900 hover:underline">Sign In</Link>
            </Button>
          ) : (
            <Button variant="outline" className="hidden md:inline-flex bg-white text-blue-900 hover:bg-gray-100 cursor-pointer">
              <Link href="/dashboard" className="text-blue-900 hover:underline">Dashboard</Link>
            </Button>
          )}
